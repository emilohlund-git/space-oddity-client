<div class="w-1/2 flex text-lg flex-col items-center gap-y-4 text-white">
	...
	<p>
		...
		however, beyond its name, this very funny card game is easy to organize during an evening with
		friends.
	</p>
	<p class="text-[#00BAFF] font-bold">
		Which one of you will be the last to have the black hole card?
	</p>
</div>
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
	<a href="#item1" class="btn btn-circle btn-disabled">❮</a>
